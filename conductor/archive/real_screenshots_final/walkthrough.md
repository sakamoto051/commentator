...
- **[privacy.html](file:///home/sakamoto/apps/commentator/lp/privacy.html)**
  - ユーザーデータの取り扱いを明記したプライバシーポリシーを新設。
  - 公開 URL: `https://sakamoto.github.io/commentator/privacy.html`
  - LPフッターおよび拡張機能のポップアップから直接アクセス可能に。
