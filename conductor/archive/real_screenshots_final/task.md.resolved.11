...
- [ ] Generate "Danmaku Hero" banner (1280x800) based on lp/hero.png aesthetic [/]
- [ ] Update project files with the new Danmaku hero banner [ ]
- [ ] Finalize and archive all project assets [ ]
