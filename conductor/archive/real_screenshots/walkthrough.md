# Walkthrough - Real Screenshots & Danmaku Hero

Refined the "Commentator" extension assets by replacing AI-generated content with real screenshots captured via Playwright, ensuring a realistic and trustworthy look.

## Changes Made

### Real Screenshots (Playwright)

- [hero.png](file:///home/sakamoto/apps/commentator/lp/hero.png) (Captured from `lp/index.html`)
